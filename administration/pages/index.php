<?php
	...
	$menus = $oMENU->find("menu_parent = $menu_parent order by ordre")->Objets();	
?>
<h1>Gestion des pages <a href="ajouter_page.php" class="btn btn-default btn-sm">Ajouter une page</a></h1>
